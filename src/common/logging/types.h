...
enum class Class : u8 {
    ...
    Applet, ///< HLE implementation of system applets. Each applet should have its own subclass.
    Applet_SWKBD, ///< The Software Keyboard applet
    Service,      ///< HLE implementation of system services. Each major service should have its own
    ///< subclass.
